// source=coordinates form=solid id =Dodecahedron
solid_1 = Dodecahedron();
p_describe(solid_1);
//rotate([20.9052, 0, 0])
//scale(1) show_solid(solid_1);

function Z() = Dodecahedron();
